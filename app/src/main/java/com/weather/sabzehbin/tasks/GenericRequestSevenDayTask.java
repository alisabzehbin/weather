package com.weather.sabzehbin.tasks;
...
import com.weather.sabzehbin.activities.MainActivity;

public abstract class GenericRequestSevenDayTask extends AsyncTask<String, String, TaskOutput> {
    ...
    public GenericRequestSevenDayTask(Context context, MainActivity activity, ProgressDialog progressDialog) {
